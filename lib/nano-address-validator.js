...
/***/ "./node_modules/nano-base32/index.js":
/*!*******************************************!*\
  !*** ./node_modules/nano-base32/index.js ***!
  \*******************************************/
/*! no static exports found */
...
var _nanoBase = _interopRequireDefault(__webpack_require__(/*! nano-base32 */ "./node_modules/nano-base32/index.js"));
 ...
 */
function _default(address) {
  var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ['nano', 'xrb'];
  ...
  var allowedPrefixes; // Ensure the prefix is valid.

  if (Array.isArray(prefix)) {
    if (prefix.some(function (currentPrefix) {
      return typeof currentPrefix !== 'string';
    })) {
  ...
  var pattern = new RegExp("^(".concat(allowedPrefixes.join('|'), ")_[13]{1}[13456789abcdefghijkmnopqrstuwxyz]{59}$")); // Validate the syntax of the address.
  ...
  var publicKeyBuffer = _nanoBase.default.decode(publicKey);
  /** The actual checksum as an array buffer. */


  var actualChecksumBuffer = _blakejs.default.blake2b(publicKeyBuffer, null, 5).reverse();
  /** The actual checksum as a base32-encoded string. */


  var actualChecksum = _nanoBase.default.encode(actualChecksumBuffer); // Validate the provided checksum against the derived checksum.
...
//# sourceMappingURL=nano-address-validator.js.map