...
function () {
   ...
   */
  function NanoAddressValidator() {
    var prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['nano', 'xrb'];
    ...
    this.pattern = new RegExp("^(".concat(this.prefix.join('|'), ")_[13]{1}[13456789abcdefghijkmnopqrstuwxyz]{59}$"));
  }
  /**
